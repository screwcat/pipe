...
namespace JobSearch.Common
{
    ...
    #region 文件说明
    // Description: Base64处理类
    // Copyright (c) 2010 UKUnion.com.  All rights reserved.
    // $Author:Ryan$
    // $Revision:$
    // $Created: $2010-12-30, $Moditime:$
    //$History:$
    ...
    public class Base64
    {
        ...
        /// <param name="ens">System.Text.Encoding 对象，如创建中文编码集对象：System.Text.Encoding.GetEncoding(65001)</param>
