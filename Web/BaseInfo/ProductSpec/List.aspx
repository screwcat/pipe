<%@ Page Title="ProductSpec" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZhangWei.Web.ProductSpec.List" %>
...
<!--Title -->
        ...
        Width="100%" cellpadding="0"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="ProductSpec_ID" OnRowDataBound="gridView_RowDataBound"
...
<RowStyle HorizontalAlign="Center"></RowStyle>
		...
		<asp:BoundField DataField="Name" HeaderText="规格名" SortExpression="Name" 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                            ...
                            DataNavigateUrlFields="ProductSpec_ID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  >
<ControlStyle Width="50px"></ControlStyle>
                        </asp:HyperLinkField>
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" 
                            DataNavigateUrlFields="ProductSpec_ID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  >
<ControlStyle Width="50px"></ControlStyle>
                        </asp:HyperLinkField>
