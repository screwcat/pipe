<%@ Page Title="Customer" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZhangWei.Web.Customer.List" %>
...
<!--Title -->
            ...
            <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
                <tr>
                    <td style="width: 80px" align="right" class="tdbg">
                         &nbsp;</td>
                    <td class="style1">                       
                        客户资料<uc2:checkright ID="checkright1" runat="server" PermissionID="8" />
        </td>
                    <td class="tdbg">
                    </td>
                </tr>
        ...
        Width="100%" cellpadding="0"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="Customer_ID" OnRowDataBound="gridView_RowDataBound"
...
<RowStyle HorizontalAlign="Center"></RowStyle>
                    <Columns>
		                ...
		                <asp:BoundField DataField="Customer_ID" HeaderText="编号" />
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                            ...
                            DataNavigateUrlFields="Customer_ID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  >
<ControlStyle Width="50px"></ControlStyle>
                        </asp:HyperLinkField>
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" 
                            DataNavigateUrlFields="Customer_ID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  >
<ControlStyle Width="50px"></ControlStyle>
                        </asp:HyperLinkField>
               ...
               <table border="0" cellpadding="0" cellspacing="1" style="width: 100%;">
                <tr>
                    ...
                    <td align="left">
                        <input id="Button1" type="button" value="添加新客户" onclick="javascript:window.location='add.aspx'" /></td>
                </tr>
            </table>
</asp:Content>
