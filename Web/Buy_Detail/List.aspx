<%@ Page Title="Buy_Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZhangWei.Web.Buy_Detail.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Buy_ID" HeaderText="Buy_ID" SortExpression="Buy_ID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Product_ID" HeaderText="Product_ID" SortExpression="Product_ID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BuyOrder_ID" HeaderText="BuyOrder_ID" SortExpression="BuyOrder_ID" ItemStyle-HorizontalAlign="Center"  /> 
