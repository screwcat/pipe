<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchProducts.aspx.cs"
    Inherits="ZhangWei.Web.ass.SearchProducts" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function transmit(obj) {
            window.parent.add_line($(obj).find("td").eq(0).html().replace(/\s+/g, ""), $(obj).find("td").eq(2).html(), $(obj).find("td").eq(5).html(), $(obj).find("td").eq(8).html(), $(obj).find("td").eq(7).html().replace(/\s+/g, ""), $(obj).find("td").eq(9).html(), $(obj).find("td").eq(6).html());
        }
    </script>
</head>
<body>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <tr align="center" onclick="transmit(this);">
                                    ...
                                    <td>
                                        <div style="width:80px; overflow:hidden"><%#Eval("spell")%></div>
                                    </td>
                                    <td>
                                        <%#Eval("SpecName")%>
                                    </td>
