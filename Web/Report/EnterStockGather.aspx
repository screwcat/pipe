<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterStockGather.aspx.cs"
    Inherits="ZhangWei.Web.Report.EnterStockGather" %>
    ...
    <script type="text/javascript">
        ...
        function startExcel() {
            ...
            $.ajax({
                ...
                cache: false,
                url: "/ajax/ajax.ashx",
                data: { Command: "EnterStockGatToExcel", according: $("#DropDownList1").val(), BeginDate: $("#TextBox1").val(), EndDate: $("#TextBox2").val() },
                dataType: "text",
                beforeSend: function() {
                    $.dialog({
                        content: '正在努力生成中，请稍候。。。。。。',
                ...
                <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TotalQty" HeaderText="入库总数量" />
                        </Columns>
                    </asp:GridView>
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="EnterStock_ID" HeaderText="单号">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="EnterDate" HeaderText="进货日期">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="StoreAdd" HeaderText="进货仓库">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:HyperLinkField DataNavigateUrlFields="EnterStock_ID" 
                                DataNavigateUrlFormatString="/warehouse/EnterStockRecordDtl.aspx?EnterStock_ID={0}" 
