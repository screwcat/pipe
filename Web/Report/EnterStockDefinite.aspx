<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterStockDefinite.aspx.cs"
    Inherits="ZhangWei.Web.Report.EnterStockDefinite" %>
    ...
    <script type="text/javascript">
        ...
        function startExcel() {
            ...
            $.ajax({
                ...
                cache: false,
                url: "/ajax/ajax.ashx",
                data: { Command: "EnterStockDefToExcel", BeginDate: $("#TextBox1").val(), EndDate: $("#TextBox2").val() },
                dataType: "text",
                beforeSend: function() {
                    $.dialog({
                        content: '正在努力生成中，请稍候。。。。。。',
                ...
                <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="StoreAdd" HeaderText="入库仓" />
                            <asp:BoundField DataField="EnterDate" HeaderText="入库日期" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
