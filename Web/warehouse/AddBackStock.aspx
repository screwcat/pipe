<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBackStock.aspx.cs" Inherits="ZhangWei.Web.warehouse.AddBackStock" %>
...
<head runat="server">
    ...
    <script src="../lhgdialog/lhgdialog.min.js?skin=mac" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function flextabz() {
            $('.zhangwei').flexigrid({ striped: true });
...
<body>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" valign="middle" bordercolor="#000"
            ...
            <tr>
                <td colspan="6" height="70" align="center" style="font-size: xx-large">
                    物品出库<uc2:checkright ID="checkright1" runat="server" PermissionID="6" />
                </td>
            </tr>
            <tr height="40">
                ...
                <td width="200">
                    <asp:TextBox ID="BackDate" runat="server" Width="139px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                        class="Wdate" AutoCompleteType="Disabled"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="BackDate"
        ...
        <div style="text-align: center">
            <br />
            <asp:Button ID="Button4" runat="server" Height="0px" Style="border: 0; background: #FFF"
                Text="" Width="16px" />
            <asp:Button ID="Button2" runat="server" Text="保 存" Height="30px" Width="120px" Font-Size="15pt"
                OnClientClick="return checkStock()" OnClick="Button2_Click" />
