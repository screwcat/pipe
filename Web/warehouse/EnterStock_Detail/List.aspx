<%@ Page Title="EnterStock_Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZhangWei.Web.EnterStock_Detail.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="EnterStock_ID" HeaderText="EnterStock_ID" SortExpression="EnterStock_ID" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="HaveInvoice" HeaderText="HaveInvoice" SortExpression="HaveInvoice" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="InvoiceNum" HeaderText="InvoiceNum" SortExpression="InvoiceNum" ItemStyle-HorizontalAlign="Center"  /> 
