<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStockContract.aspx.cs"
    Inherits="ZhangWei.Web.warehouse.AddStockContract" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" valign="middle" bordercolor="#000"
            ...
            <tr>
                <td colspan="6" height="70" align="center" style="font-size: xx-large">
                    填写入库单<uc2:checkright ID="checkright1" runat="server" PermissionID="1" />
                </td>
            </tr>
            <tr height="40">
