...
namespace ZhangWei.Web.BuyOrder
{
    public partial class List : Page
    {
        ...
        {
            Response.Redirect("/warehouse/ShowBuyOrderDetail.aspx?id=" + e.CommandArgument.ToString());
            //Model.BuyOrder boModel = new BLL.BuyOrder().GetModel(Convert.ToInt32(e.CommandArgument));
            //DataSet botDs = new BLL.BuyOrder_Detail().GetList("id = " + e.CommandArgument.ToString());
            //for (int i = 0; i < botDs.Tables[0].Rows.Count; i++)
            //{
