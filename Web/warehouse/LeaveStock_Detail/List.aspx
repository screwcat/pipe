<%@ Page Title="LeaveStock_Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZhangWei.Web.LeaveStock_Detail.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="LeaveStock_ID" HeaderText="LeaveStock_ID" SortExpression="LeaveStock_ID" ItemStyle-HorizontalAlign="Center"  /> 
