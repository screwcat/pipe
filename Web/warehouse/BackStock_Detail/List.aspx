<%@ Page Title="BackStock_Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZhangWei.Web.BackStock_Detail.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="BackStock_ID" HeaderText="BackStock_ID" SortExpression="BackStock_ID" ItemStyle-HorizontalAlign="Center"  /> 
