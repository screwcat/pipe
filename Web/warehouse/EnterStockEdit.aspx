<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterStockEdit.aspx.cs"
    Inherits="ZhangWei.Web.warehouse.EnterStockEdit" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="EnterStock_ID" 
                                DataNavigateUrlFormatString="EnterStockEditDtl.aspx?EnterStock_ID={0}" 
