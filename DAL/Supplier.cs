...
namespace ZhangWei.DAL
{
	...
	public partial class Supplier
	{
		...
		public bool Update(ZhangWei.Model.Supplier model)
		{
			...
			strSql.Append(" where Supplier_ID=@Supplier_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@Name", SqlDbType.VarChar,250),
					new SqlParameter("@Address", SqlDbType.VarChar,250),
					new SqlParameter("@Phone", SqlDbType.VarChar,25),
		...
		public bool Delete(int Supplier_ID)
		{
			...
			parameters[0].Value = Supplier_ID;
		...
		public bool DeleteList(string Supplier_IDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Supplier ");
			strSql.Append(" where Supplier_ID in ("+Supplier_IDlist + ")  ");
		...
		public ZhangWei.Model.Supplier GetModel(int Supplier_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Supplier_ID,Name,Address,Phone,Fax,PostalCode,ConstactPerson from Supplier ");
			strSql.Append(" where Supplier_ID=@Supplier_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@Supplier_ID", SqlDbType.Int,4)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Supplier_ID,Name,Address,Phone,Fax,PostalCode,ConstactPerson ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Supplier_ID,Name,Address,Phone,Fax,PostalCode,ConstactPerson ");
			strSql.Append(" FROM Supplier ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[1].Value = "Supplier_ID";
