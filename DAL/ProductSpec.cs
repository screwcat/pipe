...
namespace ZhangWei.DAL
{
	...
	public partial class ProductSpec
	{
		...
		public bool Delete(int ProductSpec_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ProductSpec ");
			strSql.Append(" where ProductSpec_ID=@ProductSpec_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ProductSpec_ID", SqlDbType.Int,4)
};
		...
		public bool DeleteList(string ProductSpec_IDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ProductSpec ");
			strSql.Append(" where ProductSpec_ID in ("+ProductSpec_IDlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ProductSpec_ID,Name,Employee_ID,CreateDate,Remark ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ProductSpec_ID,Name,Employee_ID,CreateDate,Remark ");
			strSql.Append(" FROM ProductSpec ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ProductSpec";
			parameters[1].Value = "ProductSpec_ID";
