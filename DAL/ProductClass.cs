...
namespace ZhangWei.DAL
{
	...
	public partial class ProductClass
	{
		...
		public bool Update(ZhangWei.Model.ProductClass model)
		{
			...
			strSql.Append(" where ProductClass_ID=@ProductClass_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@Name", SqlDbType.VarChar,30),
					new SqlParameter("@Employee_ID", SqlDbType.Int,4),
					new SqlParameter("@CreateDate", SqlDbType.DateTime),
			...
			parameters[2].Value = model.CreateDate;
			parameters[3].Value = model.Remark;
			parameters[4].Value = model.ProductClass_ID;
		...
		public bool Delete(int ProductClass_ID)
		{
			...
			parameters[0].Value = ProductClass_ID;
		...
		public bool DeleteList(string ProductClass_IDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ProductClass ");
			strSql.Append(" where ProductClass_ID in ("+ProductClass_IDlist + ")  ");
		...
		public ZhangWei.Model.ProductClass GetModel(int ProductClass_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ProductClass_ID,Name,Employee_ID,CreateDate,Remark from ProductClass ");
			strSql.Append(" where ProductClass_ID=@ProductClass_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ProductClass_ID", SqlDbType.Int,4)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ProductClass_ID,Name,Employee_ID,CreateDate,Remark ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[1].Value = "ProductClass_ID";
