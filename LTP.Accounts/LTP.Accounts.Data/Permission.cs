...
namespace LTP.Accounts.Data
{
    ...
    {
        public Permission(string newConnectionString)
        ...
        public int Create(int categoryID, string description)
        {
            ...
            return base.RunProcedure("sp_Accounts_CreatePermission", parameters, out num);
        }
        ...
        public bool Delete(int id)
        {
            ...
            base.RunProcedure("sp_Accounts_DeletePermission", parameters, out num);
            return (num == 1);
        }
        ...
        public DataSet GetNoPermissionList(int roleId)
        {
            ...
            {
                base.RunProcedure("sp_Accounts_GetNoPermissionList", parameters, set, "Permissions");
        ...
        public DataSet GetPermissionList()
        {
            ...
            using (DataSet set = base.RunProcedure("sp_Accounts_GetPermissionCategories", new IDataParameter[0], "Categories"))
            {
                base.RunProcedure("sp_Accounts_GetPermissionList", parameters, set, "Permissions");
                DataRelation relation = new DataRelation("PermissionCategories", set.Tables["Categories"].Columns["CategoryID"], set.Tables["Permissions"].Columns["CategoryID"], true);
                set.Relations.Add(relation);
                DataColumn[] columnArray = new DataColumn[] { set.Tables["Categories"].Columns["CategoryID"] };
                DataColumn[] columnArray2 = new DataColumn[] { set.Tables["Permissions"].Columns["PermissionID"] };
        ...
        public DataRow Retrieve(int permissionId)
        {
            ...
            using (DataSet set = base.RunProcedure("sp_Accounts_GetPermissionDetails", parameters, "Permissions"))
            {
        ...
        public bool Update(int PermissionID, string description)
        {
            ...
            parameters[0].Value = PermissionID;
            parameters[1].Value = description;
            base.RunProcedure("sp_Accounts_UpdatePermission", parameters, out num);
            return (num == 1);
        }
