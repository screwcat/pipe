...
namespace LTP.Accounts.Data
{
    public class Role : DbObject
    {
        ...
        public void AddPermission(int roleId, int permissionId)
        {
            ...
            base.RunProcedure("sp_Accounts_AddPermissionToRole", parameters, out num);
        }
        ...
        public void ClearPermissions(int roleId)
        {
            ...
            parameters[0].Value = roleId;
            base.RunProcedure("sp_Accounts_ClearPermissionsFromRole", parameters, out num);
        }
        ...
        public int Create(string description)
        {
            ...
            return base.RunProcedure("sp_Accounts_CreateRole", parameters, out num);
        }
        ...
        public bool Delete(int roleId)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@RoleID", SqlDbType.Int, 4) };
            parameters[0].Value = roleId;
            base.RunProcedure("sp_Accounts_DeleteRole", parameters, out num);
            return (num == 1);
        }

        public DataSet GetRoleList()
        {
            using (DataSet set = base.RunProcedure("sp_Accounts_GetAllRoles", new IDataParameter[0], "Roles"))
            {
                return set;
            }
        }
        ...
        public void RemovePermission(int roleId, int permissionId)
        {
            ...
            parameters[0].Value = roleId;
            parameters[1].Value = permissionId;
            base.RunProcedure("sp_Accounts_RemovePermissionFromRole", parameters, out num);
        }
        ...
        public DataRow Retrieve(int roleId)
        {
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@RoleID", SqlDbType.Int, 4) };
            parameters[0].Value = roleId;
            using (DataSet set = base.RunProcedure("sp_Accounts_GetRoleDetails", parameters, "Roles"))
            {
        ...
        public bool Update(int roleId, string description)
        {
            ...
            base.RunProcedure("sp_Accounts_UpdateRole", parameters, out num);
            return (num == 1);
        }
