...
namespace ZhangWei.BLL
{
    ...
    {
        private readonly ZhangWei.DAL.LeaveStock_Detail dal = new ZhangWei.DAL.LeaveStock_Detail();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ZhangWei.Model.LeaveStock_Detail GetModelByCache()
        {
            //该表无主键信息，请自定义主键/条件字段
            string CacheKey = "LeaveStock_DetailModel-";
            ...
            return (ZhangWei.Model.LeaveStock_Detail)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZhangWei.Model.LeaveStock_Detail> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZhangWei.Model.LeaveStock_Detail> DataTableToList(DataTable dt)
        {
            List<ZhangWei.Model.LeaveStock_Detail> modelList = new List<ZhangWei.Model.LeaveStock_Detail>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ZhangWei.Model.LeaveStock_Detail model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new ZhangWei.Model.LeaveStock_Detail();
        ...
        {
            return dal.GetTransferDtl(LeaveStock_ID);
        }
