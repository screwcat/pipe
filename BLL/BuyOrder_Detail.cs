...
namespace ZhangWei.BLL
{
    ...
    {
        private readonly ZhangWei.DAL.BuyOrder_Detail dal = new ZhangWei.DAL.BuyOrder_Detail();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ZhangWei.Model.BuyOrder_Detail GetModelByCache()
        {
            //该表无主键信息，请自定义主键/条件字段
            string CacheKey = "BuyOrder_DetailModel-";
            ...
            return (ZhangWei.Model.BuyOrder_Detail)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZhangWei.Model.BuyOrder_Detail> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZhangWei.Model.BuyOrder_Detail> DataTableToList(DataTable dt)
        {
            List<ZhangWei.Model.BuyOrder_Detail> modelList = new List<ZhangWei.Model.BuyOrder_Detail>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ZhangWei.Model.BuyOrder_Detail model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new ZhangWei.Model.BuyOrder_Detail();
        ...
        {
            return dal.GetProDetail(BuyOrder_ID);
        }
		#endregion  Method
	}
}
