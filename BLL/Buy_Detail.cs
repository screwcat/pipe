...
namespace ZhangWei.BLL
{
	...
	{
		private readonly ZhangWei.DAL.Buy_Detail dal=new ZhangWei.DAL.Buy_Detail();
		public Buy_Detail()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZhangWei.Model.Buy_Detail GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "Buy_DetailModel-" ;
			...
			return (ZhangWei.Model.Buy_Detail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZhangWei.Model.Buy_Detail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZhangWei.Model.Buy_Detail> DataTableToList(DataTable dt)
		{
			List<ZhangWei.Model.Buy_Detail> modelList = new List<ZhangWei.Model.Buy_Detail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZhangWei.Model.Buy_Detail model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZhangWei.Model.Buy_Detail();
